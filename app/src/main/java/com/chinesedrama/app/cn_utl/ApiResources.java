package com.chinesedrama.app.cn_utl;
...
public class ApiResources {
    ...
    String getSeriesbyCountry = URL+"get_series_by_country_id?"+API_SECRECT_KEY;
    ...
    public String getGetSeriesbyCountry() {
        return getSeriesbyCountry;
    }

    public void setGetSeriesbyCountry(String getSeriesbyCountry) {
        this.getSeriesbyCountry = getSeriesbyCountry;
    }
